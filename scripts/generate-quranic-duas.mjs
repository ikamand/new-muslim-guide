 ...
 * is called — "The dua of Yūnus" rather than a title invented for it. Ordered
 * roughly as the Qur'an tells them, prophets first and the believers' own
 * duas after, because that is the order somebody meets them in.
 */
/*
  ...
  that were two cards of one dua became one card (2:127–128, 3:8–9,
...
const DUAS = [
  ...
  // quarters of a dua, each missing the reason for the rest.
...
console.log(`The duas of the Qur'an — ${DUAS.length} references, from QuranEnc\n`);
