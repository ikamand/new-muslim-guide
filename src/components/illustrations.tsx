...
import { DAY_MARK_PARTS, type DayMark } from '@/constants/day-marks';
...
export type DayMarkName = DayMark;
...
function dayMarkPaths(name: DayMarkName) {
  // The drawings live as data in `constants/day-marks.ts`, where the home-screen widgets read them too.
  return DAY_MARK_PARTS[name].map((part, index) =>
    'd' in part ? (
