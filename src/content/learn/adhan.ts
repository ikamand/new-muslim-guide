 ...
 *
 * The app had nothing on the adhan at all; the word appeared only as the name
 ...
 *
 * ⚠️ The WORDS of the adhan are deliberately not printed here. Hisn al-Muslim's
...
export const ADHAN: Reference = {
  ...
  subtitle: 'What the adhan is, and what to do when you hear it',
  meta: {
    category: 'salah',
