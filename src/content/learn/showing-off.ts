  ...
  sections: [
    {
      ...
      body:
        'It is doing an act of worship so that people see you doing it. The narration is blunt about the exchange: whoever makes his deed heard of, Allah will make him heard of; whoever does it to be seen, Allah will show him up. You asked to be looked at, and you will be — which is exactly the payment, and the whole of it.',
      sources: [
        hadith('bukhari', '6499', {
          book: 81,
    ...
    },
    {
      ...
      */
      promote: 'hero',
      body:
        'Because of what it does to the deed itself. In a ḥadīth qudsī, Allah says He is the least in need of a partner: whoever does something and associates another with Him in it, He leaves him and the one he associated. The deed is not reduced. It is handed over to the person you did it for.',
      sources: [
        hadith('muslim', '2985', {
          book: 55,
    ...
    },
    {
      ...
      body:
        'No, and this is the question converts actually have rather than the one the topic is usually written for. Praying at work, fasting in front of colleagues, saying you cannot drink — all of that is visible, and none of it is riyāʾ, because you would be doing it in an empty room. Riyāʾ is not the presence of an audience. It is the audience being the reason.',
      sources: [
        {
          kind: 'general',
          basis:
