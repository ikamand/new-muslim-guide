  ...
  sections: [
    {
      ...
      sources: [
        general(
          'An observation about the position converts find themselves in, claiming no textual authority. What may be conveyed is cited below.',
        ),
      ],
    },
    {
      ...
      body:
        'To pass on what you actually know, yes. The Prophet ﷺ said to convey from him even a single sentence — which is a low bar deliberately, and it is a bar about accuracy rather than about credentials. What you are not qualified to do is answer questions you have not been taught the answer to, and the difference between those two is the whole of this page.',
    ...
    },
    {
      ...
      body:
        '"I don’t know." Then, if you can: "let’s find out." That is a complete answer, it is honest, and it is what scholars say constantly — the ones worth listening to say it more often than anyone.\n\nThe temptation is to fill the gap, because being asked feels like being trusted and saying nothing feels like letting somebody down. It is not. Guessing at a ruling for somebody who will act on it is a considerably worse outcome than a pause.',
      notes: [
        note(
          'practical',
          'Watch for the question that is really about somebody’s specific situation — a marriage, money, family. Those need a person who can ask questions back, and that is rarely you.',
        ),
      ],
    },
    {
      ...
      body:
        'Say so. "There is more than one view on that, and mine is what my mosque follows" is more useful to a beginner than a confident single answer, because it prepares them for the day somebody tells them otherwise.\n\nThis is the thing most likely to have been done TO you, and the easiest not to pass on.',
      sources: [
        general(
          'Advice on how to present a difference, not a ruling on the differences themselves. `learn/why-people-differ.ts` is the page about those.',
        ),
      ],
    },
    {
