...
export const PILLARS: Pillar[] = [
  ...
  },
  {
    ...
    detail:
      'Zakat is not a donation you choose to make. It is a portion of your savings that stops being yours. It applies only above a threshold, and only to wealth you have held for a full lunar year, so many people newly earning owe none at all. The app can work out the sum for cash, gold and silver. It counts nothing else, and whether zakat applies to you is still worth asking someone locally.',
    meta: {
      category: 'charity',
      difficulty: 'building',
      estimatedMinutes: 2,
