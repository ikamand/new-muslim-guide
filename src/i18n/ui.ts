...
export const EN = {
  ...
  */
  ...
  'pray.intro': 'Every prayer is the same movements and the same words. What changes is the count, and whether the Qur’an is said aloud.',
  'pray.before': 'before',
  'pray.fard': 'obligatory',
  /* The two-word glossary under the intro — the term bold, keyed by a dot in
     the term's colour (lapis for the count, gold for the sunnah). Kept as
     'term = meaning' in ONE string so a translation cannot split them. */
  'pray.legend.obligatory': 'Obligatory = required',
  'pray.legend.sunnah': 'Sunnah = recommended',
  'pray.sunnah': 'Sunnah',
  'pray.none': 'none',
  'pray.after': 'after',
  'pray.rawatib': 'Twelve sunnah rakʿahs a day, across the five. The four before Dhuhr are prayed as two prayers of two.',
  'step.openSurah': 'Open this surah to practise →',
  'pray.chosen': 'Prayed by choice',
  'pray.chosen.help': 'None of these is obligatory. They are the prayer you already know. What differs is why you are standing there.',
