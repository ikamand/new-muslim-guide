...
const FR: Overrides = {
  ...
  'quran.intro': 'Al-Fatihah, puis les sourates courtes de la fin du Coran, dans l’ordre où on les apprend habituellement. Commencez par le haut — Al-Fatihah est dans chaque prière, c’est donc celle à connaître en premier.',
...
const ES: Overrides = {
  ...
  'quran.intro': 'Al-Fatihah y luego las suras cortas del final del Corán, en el orden en que suelen aprenderse. Empieza por arriba — Al-Fatihah está en cada oración, así que es la primera que conviene saber.',
